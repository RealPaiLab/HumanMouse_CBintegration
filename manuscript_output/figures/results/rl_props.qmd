---
title: "RL cell type proportions tests (differential abundance)"
---

Code for figures showing the proportion tests in the RL lineage. Note that the code chunks are run interactively using the `scrnaseq_env` conda environment. This file was **not** rendered with `quarto render`.

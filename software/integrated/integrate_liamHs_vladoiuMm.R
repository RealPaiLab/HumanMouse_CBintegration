# ==============================================================================
# Integrate full Vladoiu mouse cells with Liam's RL-derived human cells
# ==============================================================================
...
vlad_srat <- readRDS(file.path(mouse_out_dir, "Vladoiu/merged_seurat.rds"))
...
vlad_srat_hgene <- rename_genes(vlad_srat, old_genes = m2h_genes$MGI.symbol, new_genes = m2h_genes$HGNC.symbol)
...
saveRDS(object = integ_srat,
        file = file.path(integ_out_dir, "vladoiu_liam_integrated.rds"))

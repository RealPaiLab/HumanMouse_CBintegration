...
outRoot <- "/home/rstudio/isilon/private/projects/HumanMouseUBC/SingleR_UBCclusters_Vladoiu"
...
if (file.exists(singleRFile)){
    ...
    keep_idx <- which(!rl_srat[[]]$RLwithUBC %in% c("UBC","UBC6"))
...
markerGenes <- c("OTX2","CRX","MYC","MYCN","BRCA1",
    "GLI2","PAX6","EOMES")

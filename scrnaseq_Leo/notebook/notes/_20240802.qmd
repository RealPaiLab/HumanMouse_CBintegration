...
1. Convert Seurat object to AnnData object for CellTypist
2. Try out CellTypist
...
The output can be found at `/.mounts/labs/pailab/private/llau/results/integrated/20240802`
...
```{r}
set.seed(1)
out_directory <- "/.mounts/labs/pailab/private/llau/results/integrated/20240802"
...
Convert to AnnData
```{r}
source("/u/llau/software/mb_scrnaseq/MB_scRNAseq/scrnaseq_Leo/utilities/seurat_to_anndata.R")

seurat_to_anndata(
  srat_object = rl_srat,
  assay = c("RNA", "integrated"),

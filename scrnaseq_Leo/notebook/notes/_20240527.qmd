---
title: Subsetting UBCs from 25 PC RL Lineage
date: 2024-05-27
metadata-files: 
  - _metadata.yml
  - ../_quarto.yml
...
1. Subset UBCs from RL Lineage
2. Rerun clustering at 25 PCs
3. Perform permutation test to determine significance of species-specific clusters

# Files and directories

## Input

The RL lineage file can be found at `/.mounts/labs/pailab/private/llau/results/integrated/20240524/25_pc_without_luo/25_pc_rl.qs`  

## Output

The output directory can be found at `/.mounts/labs/pailab/private/llau/results/integrated/20240527`
The UBC subset generated can be found at `/.mounts/labs/pailab/private/llau/results/integrated/20240527/ubc_subset.qs`
...
Lets set a seed for the statistical analysis
```{r eval=FALSE}
set.seed(1)
```

## Separate UBCs from RL integration

Firstly, lets load in the RL lineage file. The UBC Cluster is Cluster 2 at 0.4 resolution.
...
![Cells from Clusters 19 and 20 (human-enriched) from Ian's original integration](/.mounts/labs/pailab/private/llau/results/integrated/20240527/cluster_19_20_cells.png)

![The cells from Cluster 7 (homologous) from Ian's original integration](/.mounts/labs/pailab/private/llau/results/integrated/20240527/cluster_7_cells.png)

![Original UBC cells of Ian's initial integration](/.mounts/labs/pailab/private/llau/results/integrated/20240527/cluster_7_19_20_cells.png)
...
![The UBCs seems to have an age gradient.](/.mounts/labs/pailab/private/llau/results/integrated/20240527/ages_colour_scale_umap.png)

Lets continue the analysis for cluster resolutions 0.1, 0.2, and 0.3.

## 0.1 Resolution

![0.1 Resolution Clustering](/.mounts/labs/pailab/private/llau/results/integrated/20240527/0.1_cluster_umap.png)
...
![0.1 Resolution Species Barplot](/.mounts/labs/pailab/private/llau/results/integrated/20240527/0.1_species_bar_plot.png)
...
![0.1 Resolution of where the original UBCs are clustering](/.mounts/labs/pailab/private/llau/results/integrated/20240527/0.1_original_clusters_bar_plot.png)
...
![Permutation Test at 0.1 resolution. If a cluster has a positive log fold change past the dotted line, it is more human-specific.](/.mounts/labs/pailab/private/llau/results/integrated/20240527/0.1_permutation_test.png)

## 0.2 Resolution

![0.2 Resolution Clustering](/.mounts/labs/pailab/private/llau/results/integrated/20240527/0.2_cluster_umap.png)
...
![0.2 Resolution Species Barplot](/.mounts/labs/pailab/private/llau/results/integrated/20240527/0.2_species_bar_plot.png)
...
![0.2 Resolution of where the original UBCs are clustering](/.mounts/labs/pailab/private/llau/results/integrated/20240527/0.2_original_clusters_bar_plot.png)
...
![Permutation Test at 0.2 resolution. If a cluster has a positive log fold change past the dotted line, it is more human-specific.](/.mounts/labs/pailab/private/llau/results/integrated/20240527/0.2_permutation_test.png)

## 0.3 Resolution

![0.3 Resolution Clustering](/.mounts/labs/pailab/private/llau/results/integrated/20240527/0.3_cluster_umap.png)
...
![0.3 Resolution Species Barplot](/.mounts/labs/pailab/private/llau/results/integrated/20240527/0.3_species_bar_plot.png)
...
![0.3 Resolution of where the original UBCs are clustering](/.mounts/labs/pailab/private/llau/results/integrated/20240527/0.3_original_clusters_bar_plot.png)
...
![Permutation Test at 0.3 resolution. If a cluster has a positive log fold change past the dotted line, it is more human-specific.](/.mounts/labs/pailab/private/llau/results/integrated/20240527/0.3_permutation_test.png)
...
![Clustree analysis](/.mounts/labs/pailab/private/llau/results/integrated/20240527/tree_plot.png)
...
Now that we have the results and it seems like the number of PCs doesn't affect the end result very much. We have to prove that the human-specific cluster are due to biological reasons and not other reasons and investigate the reasons for the mice specific clusters.

Species specific cluster ar not because of:

**Missing time points**

- Time points the human specific clusters are from and that we have a corresponding mice time point or vice versa

**Integration**

- Show the controls integrating fine and potentially a second integration method (Harmony). If we get similar results that is good

**Batch effect**

- Show that multiple datasets are integrating into these clusters

**Note**
Ian extracted the metadata from ubc_subset.qs using:
```{r eval=FALSE}
write.csv(srat[[]], file = ...)
```

And saved as ubc_subset_metadata.csv

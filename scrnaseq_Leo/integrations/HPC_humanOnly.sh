...
destination_dir="/.mounts/labs/pailab/private/projects/HumanMouseUBC/results/integrated/${destination_date}"

# Run your script
echo "Starting integration"
mkdir "$destination_dir"
cp ./HPC_job_parallel.sh "${destination_dir}"
Rscript HPC_integrate.R -datasets Aldinger_RL_human Sepp_RL_human --CCA_int --run_series 

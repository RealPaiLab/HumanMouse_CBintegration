...
destination_dir="/.mounts/labs/pailab/private/projects/HumanMouseUBC/results/integrated_MmRL/${destination_date}"

# Run your script
echo "Starting integration"
mkdir "$destination_dir"
cp ./HPC_job_parallel.sh "${destination_dir}"
Rscript HPC_integrate.R -datasets Vladoiu_RL_mouse Sepp_RL_mouse --CCA_int --run_series 

...
if (interactive()) {
  ...
  arg_list <- parser$parse_args(c(
    "--de_genes", "/.mounts/labs/pailab/private/projects/HumanMouseUBC/integrated_human_ubc/20250304/de_genes.tsv",
    "--out_dir", "/.mounts/labs/pailab/private/projects/HumanMouseUBC/integrated_human_ubc/20250307/"
  ))
} else {
